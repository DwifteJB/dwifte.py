...
funfact = ['This bot uses python!', 'We all hate ourselfs, in one way.', 'Let's ddos ourself', 'This fact was removed because it was not funny', 'This fact was removed due to dmca trouble', 'Imagine jailbreaking, couldn't be me ;)']
